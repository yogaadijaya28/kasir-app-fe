...
import { SideBar, RightBar, Menus } from '../components';
  ...
  render() {
    ...
    return (
        <div className='mt-3'>
          <Container fluid>
            <Row>
              <SideBar changeCategory={this.changeCategory} chooseCategory={chooseCategory} />
              <Col>
                <h5>
              ...
              <RightBar keranjangs={keranjangs} />
            </Row>
          </Container>
